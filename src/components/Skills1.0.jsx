      ...
      <div className="container" data-aos="fade-up">
        ...
        <div className="row justify-content-center">
          {[
            ...
            { skill: "JavaScript", percentage: 80, color: "#f0db4f" },
            { skill: "TypeScript", percentage: 60, color: "#3178c6" },
            { skill: "React.js", percentage: 75, color: "#61dafb" },
            { skill: "Redux.js", percentage: 70, color: "#764abc" },
            { skill: "Bootstrap", percentage: 85, color: "#563d7c" },
            { skill: "Tailwind CSS", percentage: 80, color: "#06b6d4" },
            { skill: "Express.js", percentage: 70, color: "#00758f" },
            { skill: "Node.js", percentage: 65, color: "#8cc84b" },
            { skill: "MongoDB", percentage: 60, color: "#47a248" },
            { skill: "Core-Java", percentage: 70, color: "#f89820" },
            { skill: "C", percentage: 70, color: "#f89820" },
            { skill: "SQL", percentage: 70, color: "#f89820" },
            { skill: "Git", percentage: 75, color: "#f1502f" },
            { skill: "GitHub", percentage: 80, color: "#181717" },
            { skill: "Figma", percentage: 70, color: "#f24e1e" },
            { skill: "Web Development", percentage: 85, color: "#007acc" },
            { skill: "Responsive Design", percentage: 90, color: "#007acc" },
          ].map((item, idx) => (
            <div className="col-6 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center" key={idx} data-aos="fade-up" data-aos-delay={idx * 50}>
              <SkillCircle skill={item.skill} percentage={item.percentage} color={item.color} />
            </div>
          ))}
        </div>
      </div>
